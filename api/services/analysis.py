...
- self_criticism_score: 0-1 (כמה ביקורת/רחמים/האשמה על עצמי)
- self_compliment_score: 0-1 (כמה שבח/הוקרה/גאווה על עצמי — "עשיתי טוב", "אני גאה")
- compliment_others_score: 0-1 (כמה המשתמש משבח/מפרגן לאנשים אחרים בדיבור)
- external_positive_score: 0-1 (כמה המשתמש מתאר אנשים אחרים שהרימו לו — "היא אמרה שאני...", "הוא עזר לי")
- external_negative_score: 0-1 (כמה המשתמש מתאר אנשים שהורידו לו — ביקורת/ציניות/זלזול שקיבל, "הוא אמר לי ש...")
